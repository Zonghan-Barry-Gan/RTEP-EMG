    ...
    iP1Motion( 0 )
{
    ...
    cTimer = new QtCppTimer;
    //execute every 20ms = 20,000,000ns
    cTimer->start(20000000);
    //iTimer->setInterval(2);
    //condition of timer start
    iTimer->start();
    QObject::connect(cTimer, SIGNAL(timeout()), this, SLOT(Position()));
